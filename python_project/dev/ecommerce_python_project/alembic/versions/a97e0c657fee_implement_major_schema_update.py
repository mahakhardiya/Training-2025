...
def upgrade() -> None:
    ...
    op.add_column('order_items', sa.Column('price_at_purchase', sa.Float(), nullable=False, server_default='0.0'))
    
    op.add_column('orders', sa.Column('created_at', sa.DateTime(), nullable=True))
    op.add_column('orders', sa.Column('total_amount', sa.Float(), nullable=False, server_default='0.0'))
    op.add_column('orders', sa.Column('status', order_status_enum, nullable=False, server_default='PENDING'))
